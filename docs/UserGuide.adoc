...
Shows all the modules that can be taken in a given semester based on whether its prerequisites have been met. +
This semester need not currently exist in the module planner for you to view its valid modules. +
