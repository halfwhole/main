 ...
 * As such, adding, updating and removing of semesters uses Semester#equals(Semester) for equality so as to ensure that
 * the semester is unique in terms of identity in the UniqueSemesterList.
 *
